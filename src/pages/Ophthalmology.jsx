...
const PainOphthalmologyBilling = () => {
  return (
    <div>
      {/* Intro Section */}
      <section className="relative py-12 overflow-hidden text-center text-white bg-blue-500 sm:py-16 lg:py-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold">Pain Ophthalmology</h2>
      ...
      <div className="px-6 py-12 mx-auto bg-white max-w-7xl">
        ...
        <h2 className="text-3xl font-bold text-center">
          <span className="text-blue-500">Pain Ophthalmology</span> Billing Services We Offer
        </h2>
        ...
        <h3 className="mt-12 text-2xl font-bold text-center">
          Common Challenges In <span className="text-blue-500">Pain Ophthalmology</span> Billing
        </h3>
...
export default PainOphthalmologyBilling;